 ...
 *
 *  Generated on 2000/04/01, 16:29:28 from xixlogm
...
int  put_xixlog_open         (byte **_buffer, char *log_path, char *log_file, char *log_format, char *cycle_when, char *cycle_how, char *cycle_time, char *cycle_date, char *cycle_size, char *cycle_lines, char *cycle_argument, Bool  translate);
...
#define XIXLOG_LOG "ssssssssqqqsssss"
...
int  put_xixlog_log          (byte **_buffer, char *ip_client, char *ip_server, char *user_name, char *service, char *request, char *query, char *method, char *response, qbyte size_recd, qbyte size_sent, qbyte time_ms, char *referer, char *agent, char *from, char *file_name, char *vhost_name);
