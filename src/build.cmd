...
CALL AssertFileExists 'smtpipe.c'
CALL AssertFileExists 'smtpipe.l'
CALL AssertFileExists 'smtpipe.d'
CALL AssertFileExists 'smtpipe.i'
...
CALL AssertFileExists 'formio.c'
...
CALL AssertFileExists 'xisuper.c'
CALL AssertFileExists 'xisuper.l'
CALL AssertFileExists 'xisuper.d'
CALL AssertFileExists 'xisuper.i'

/* require xiddns.c   xiddns.l  xiddns.d  xiddns.i */
CALL AssertFileExists 'xiddns.c'
CALL AssertFileExists 'xiddns.l'
CALL AssertFileExists 'xiddns.d'
CALL AssertFileExists 'xiddns.i'

/* require xixssi.c   xixssi.l  xixssi.d  xixssi.i */
CALL AssertFileExists 'xixssi.c'
CALL AssertFileExists 'xixssi.l'
CALL AssertFileExists 'xixssi.d'
CALL AssertFileExists 'xixssi.i'

/* require xixxml.c   xixxml.l  xixxml.d  xixxml.i */
CALL AssertFileExists 'xixxml.c'
CALL AssertFileExists 'xixxml.l'
CALL AssertFileExists 'xixxml.d'
CALL AssertFileExists 'xixxml.i'
...
CALL AssertFileExists 'xiimap.c'
CALL AssertFileExists 'xiimap.l'
CALL AssertFileExists 'xiimap.d'
CALL AssertFileExists 'xiimap.i'
...
CALL AssertFileExists 'xiadm27.h'
CALL AssertFileExists 'xiadm28.h'
CALL AssertFileExists 'xiadm29.h'

/* require xiadm30.h xiadm31.h */
CALL AssertFileExists 'xiadm30.h'
CALL AssertFileExists 'xiadm31.h'
...
CALL CompileToLib 'smtpipe' 'libsmt'
...
/* compile formio */
CALL CompileToLib 'formio' 'libsmt'
...
CALL CompileToLib 'xixssi' 'libsmt'
CALL CompileToLib 'xixxml' 'libsmt'
CALL CompileToLib 'xilrwp' 'libsmt'
CALL CompileToLib 'xisuper' 'libsmt'

/* compile xiddns xiimap */
CALL CompileToLib 'xiddns' 'libsmt'
CALL CompileToLib 'xiimap' 'libsmt'
